    ...
    class Meta:
        ...
        widgets = {
            "position": forms.TextInput(
                attrs={"placeholder": "Ex: Développeur Backend Django"}
            ),
            "company": forms.TextInput(attrs={"placeholder": "Ex: OpenAI"}),
            "job_offer_link": forms.URLInput(
                attrs={"placeholder": "Ex: https://www.example.com/job-offer"}
            ),
...
class ApplicationFollowUpForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(attrs={"placeholder": "Ex: Premier entretien RH"}),
