...
urlpatterns = [
    ...
    path("applications/<int:followup_id>/followup/update/", ApplicationFollowUpUpdateView.as_view(), name="update-followup"),
    path("applications/<int:followup_id>/followup/delete/", ApplicationFollowUpDeleteView.as_view(), name="delete-followup"),
]
