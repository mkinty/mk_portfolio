...
urlpatterns = [
    path(
        "<int:user_id>/",
        ApplicationsTrackingIndexView.as_view(),
        name="applications-index",
    ),
    path(
        "applications/<int:user_id>/",
        ApplicationsTrackingView.as_view(),
        name="applications-tracking",
    ),
    # job applications
    path(
        "applications/<int:user_id>/add/",
        JobApplicationAddView.as_view(),
    ...
    path(
        ...
        JobApplicationDeleteView.as_view(),
        name="delete-application",
    ),
    # follow-up
    path(
        "applications/<int:application_id>/followup/add/",
        ApplicationFollowUpAddView.as_view(),
        name="add-followup",
    ),
    path(
        "applications/<int:followup_id>/followup/update/",
        ApplicationFollowUpUpdateView.as_view(),
        name="update-followup",
    ),
    path(
        "applications/<int:followup_id>/followup/delete/",
        ApplicationFollowUpDeleteView.as_view(),
