...
urlpatterns = [
    ...
    path(
        ...
        TechStackCategoryAddView.as_view(),
        name="add-category",
    ),
    path(
        "<int:tech_category_id>/update-category/",
        TechStackCategoryUpdateView.as_view(),
        name="update-category",
    ),
    path(
        "<int:tech_category_id>/delete-category/",
        TechStackCategoryDeleteView.as_view(),
