...
urlpatterns = [
    ...
    path("<int:certification_id>/update/", CertificationsUpdateView.as_view(), name="update"),
    path("<int:certification_id>/delete/", CertificationsDeleteView.as_view(), name="delete"),
]
