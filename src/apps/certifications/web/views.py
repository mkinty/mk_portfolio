    ...
    def post(self, request, user_id):
        ...
        if not success:
            messages.error(request,
                           "Erreur lors de l'ajout de la certification ! Veuillez vérifier les champs du formulaire.")
...
class CertificationsUpdateView(View):
    ...
    def get(self, request, certification_id):
        ...
        form, certification = CertificationsServices.get_update_certification_form(certification_id)
        return render(request, self.template_name, {
            "form": form,
    ...
    def post(self, request, certification_id):
        ...
        if not success:
            messages.error(request,
                           "Erreur lors de la mise à jour de la certification ! Veuillez vérifier les champs du formulaire.")
            return render(request, self.template_name, {
                "form": form,
                "certification": certification,
                "title": self.title
...
class CertificationsDeleteView(View):
    ...
    def post(self, request, certification_id):
        ...
        if not success:
            messages.error(request, "Erreur lors de la suppression de la certification!")
